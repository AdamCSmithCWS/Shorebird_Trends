...
# Species loop ------------------------------------------------------------
output_dir <- "d:/Shorebird_Trends/output"
#output_dir <- "output"
...
for(sp in sps){
  ...
  if(file.exists(paste0(output_dir,"/",out_base,"_fit.RData"))){
    ...
    if(grepl(x = mod.file,pattern = "two_season")){
      ...
      pdf(file = paste0("Figures/",sp,LYYYY,"_cmd_simple_Season.pdf"),
          width = 8.5,
          height = 8.5)
      ...
      pdf(file = paste0("Figures/",sp,LYYYY,"_cmd_simple_Season_simplified.pdf"),
          width = 8.5,
          height = 8.5)
      print(pp_simple)
      dev.off()
      ...
      pdf(file = paste0("Figures/",sp,"_cmd_simple_Season.pdf"),
          width = 8.5,
          height = 8.5)
    ...
    AA_y_p <- ggplot(data = alphas_yr,aes(x = YearCollected,y = mean_alpha))+
      ...
      xlab("")+
      labs(title = paste(sp,"_mean site-effect of included sites by year"))
    
    pdf(file = paste0("Figures/",sp,LYYYY,"_cmd_alphas_by_yr.pdf"),
        width = 8.5,
        height = 8.5)
    print(AA_y_p)
    ...
    #     
        ...
        N_gg = ggplot(data = indices,aes(x = year, y = median,fill = parm))+
          ...
          labs(title = paste(sp,"_Survey-wide trajectory (full and smooth) with obs means"))+
        ...
        pdf(paste0("figures/",sp,LYYYY,FYYYY,"_cmd_GAMYE_survey_wide_trajectory_simple.pdf"))
        print(N_gg)
        dev.off()
        ...
        N_gg_simple = ggplot(data = indices,aes(x = year, y = median,fill = parm))+
          geom_ribbon(aes(ymin = lci,ymax = uci),alpha = 0.2)+
          geom_line(aes(colour = parm))+
          labs(title = paste(sp,"_Survey-wide trajectory (full and smooth)"))+
          my_col2_traj+
          xlab("")+
    ...
    # pdf(paste0("figures/",sp,FYYYY,"_GAMYE_survey_wide_trajectory_simple.pdf"))
    # print(N_gg_simple)
    # dev.off()
    ...
    #     
    #     
    #     pdf(file = paste0("figures/", sp,FYYYY,"_cmd_GAMYE_Strata_trajectories_simple.pdf"),
    #         width = 8.5,
    #         height = 11)
    #     print(N_gg)
    #     # ncl = 3
    ...
    # 
        ...
        #     theme(legend.position = "none")+
        #   scale_y_log10()
        # pdf(paste0("Figures/log_scale_trajectories_",sp,"_cmd_.pdf"),
        #     width = 11,
        #     height = 8.5)
        # print(n_gg_over)
        # dev.off()
    ...
    #     
    #     
    #     pdf(paste0("Figures/beta_sdbeta_",sp,"_cmd_.pdf"),
    #         width = 11,
    #         height = 8.5)
    #     print(b_plot)
    #     dev.off()
    ...
    pdf(paste0("Figures/Trend_Heat_maps_",sp,LYYYY,"_cmd_.pdf"),
        width = 11,
        height = 8.5)
...
write.csv(trendsout,paste0("trends/All_region_strata_composite_trends.csv"),row.names = FALSE)
...
write.csv(trendsoutsplit[[1]],paste0("trends/All_strata_level_trends.csv"),row.names = FALSE)
write.csv(trendsoutsplit[[2]],paste0("trends/All_region_level_trends.csv"),row.names = FALSE)

write.csv(TRENDSout,paste0("trends/All_survey_wide_trends.csv"),row.names = FALSE)

write.csv(Trend_difout,paste0("trends/All_survey_wide_Differences_in_trends.csv"),row.names = FALSE)
...
save(list = c("trend_maps_1980",
              ...
              "season_graphs",
              "loo_ic"),
     file = paste0("Figures/All_stored_maps.RData"))
...
# Trend maps --------------------------------------------------------------
pdf(file = paste0("Figures/All_trend_maps.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
# Season Graphs --------------------------------------------------------------
pdf(file = paste0("Figures/All_Season_graphs.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
pdf(file = paste0("Figures/All_imple_Season_graphs.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
pdf(file = paste0("Figures/All_Continental_Trajectories.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
pdf(file = paste0("Figures/All_Strata_Trajectories.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
pdf(file = paste0("Figures/All_Composite_Trajectories.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
pdf(file = paste0("Figures/All_Diagnostic_Continental_Trajectories.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
pdf(file = paste0("Figures/All_Diagnostic_Strata_Trajectories.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
pdf(file = paste0("Figures/All_alphas_by_yr.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
...
pdf(file = paste0("Figures/All_long_short_term_trends.pdf"),
    height = 9,
    width = 6.5)
print(lt_tplot)
dev.off()
...
pdf(file = paste0("Figures/First_last_15Year_trends.pdf"),
    height = 9,
    width = 6.5)
print(FL15_tplot)
dev.off()
...
pdf(file = paste0("Figures/All_early_recent_3generation_trends.pdf"),
    height = 9,
    width = 6.5)
print(el_tplot)
dev.off()
...
pdf(file = paste0("Figures/All_long_term_3Gen_trends.pdf"),
    height = 9,
    width = 6.5)
print(lt3_tplot)
dev.off()
...
pdf(file = paste0("Figures/All_beta_plots.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
  if(!is.null(sp_ind_plots_strat_diagnostic[[sp]])){
...
pdf(file = paste0("Figures/All_trajectory_plots.pdf"),
    width = 9, height = 6.5)
for(sp in sps){
  if(!is.null(sp_ind_plots_strat_diagnostic[[sp]])){
...
pdf(file = paste0("Figures/All_Differences_in_trends_long_term_3Gen_trends.pdf"),
    height = 9,
    width = 6.5)
print(dif_tplot)
dev.off()
...
pdf(file = paste0("Figures/All_Differences_in_trends_all_previous_3Gen_trends.pdf"),
    height = 9,
    width = 6.5)
print(dif_tplot2)
dev.off()
...
pdf(file = paste0("Figures/All_Differences_in_trends_early_Vs_late_3Gen_trends.pdf"),
    height = 9,
    width = 6.5)
print(dif_tplot3)
dev.off()
